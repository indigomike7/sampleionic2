		...
		<script type="text/javascript">
            ...
            function doSubmit(form) {
            	...
            	try{
                    ...
                    $.ajax({
                        url: 'api.php/video/upload',  //server script to process data
                        headers: {
                            "token": sToken
                        },
                        type: 'POST',
                    ...
                    <td width="500">
                        <form method="post" action="http://dev3.younetco.com/phrase3/upload/module/mfox/api.php" id="gform" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <div>
                                    <input class="text" maxlength="200" type="text" name="sDescription" value=""/>
                                </div>
                            </div>
                            <div>
                                <div>
                                ...
                                <div>
                                    <input class="text" maxlength="200" type="text" name="sTagList" value=""/>
                                </div>
                            </div>
                            <div>
                                <div>
                            ...
                            <div>
                                ...
                                <div>
                                    <input class="text" maxlength="200" type="text" name="iCategoryId" value=""/>
                                </div>
                            </div>
                            <div>
                                <div>
                            ...
                            <div>
                                <div>
                                    Parent user id (In profile only):
                                </div>
                                <div>
