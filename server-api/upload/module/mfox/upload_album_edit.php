		...
		<script type="text/javascript">
            ...
            function doSubmit(form) {
            	try{
                    ...
                    $.ajax({
                        url: 'api.php/album/edit',  //server script to process data
                        headers: {
                            "token": sToken
                        },
                        type: 'POST',
                ...
                <tr>
                    <td width="500">
                        <form method="post" action="http://localhost/projects/debug/upload/module/mfox/api.php" id="gform" enctype="multipart/form-data">
                            <div>
                                <div>Token:</div>
                                <div><input class="text" maxlength="200" type="text" name="token" value="" id="sToken"/></div>
                            </div>
                            <div>
                                <div>iAlbumId:</div>
                                <div><input class="text" maxlength="200" type="text" name="iAlbumId" value=""/></div>
                            </div>
                            <div>
                                <div>sName:</div>
                                <div><input class="text" maxlength="200" type="text" name="sName" value=""/></div>
                            </div>
                            <div>
                                <div>sYear:</div>
                                <div><input class="text" maxlength="200" type="text" name="sYear" value=""/></div>
                            </div>
                            <div>
                                <div>sText:</div>
                                <div><input class="text" maxlength="200" type="text" name="sText" value=""/></div>
                            </div>
                            <div>
                                <div>Privacy:</div>
                                <div><input class="text" maxlength="200" type="text" name="iPrivacy" value=""/></div>
                            </div>
                            <div>
                                <div>
                                    Privacy Comment:
