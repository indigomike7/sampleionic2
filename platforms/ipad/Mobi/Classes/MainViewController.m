...
- (void)webViewDidFinishLoad:(UIWebView*)theWebView
{
    ...
    CGRect viewBounds = CGRectMake([[UIScreen mainScreen] applicationFrame].origin.x, [[UIScreen mainScreen] applicationFrame].origin.y - 20, [[UIScreen mainScreen] applicationFrame].size.width, [[UIScreen mainScreen] applicationFrame].size.height-CGSizeFromGADAdSize(kGADAdSizeSmartBannerLandscape).height + 20);
    ...
    bannerView_.adUnitID = @"ca-app-pub-6253688624927798/6719261105";
    
    bannerView_.rootViewController = self;
    
    self.iAdViewHeight = 90;
